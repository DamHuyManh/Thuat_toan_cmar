...
| Hepatitis | 155 | 19 | 2 | **83.4%** | 80.5% | 81.8% | 80.6% | +2.9% |
...
| Lymphography | 148 | 18 | 4 | **84.5%** | 83.1% | 77.8% | 73.5% | +1.4% |
| Pima | 768 | 8 | 2 | **73.4%** | 75.1% | 72.9% | 75.5% | -1.7% |
| Sick | 2800 | 29 | 2 | **96.8%** | 97.5% | 97.0% | 98.5% | -0.7% |
| Sonar | 208 | 60 | 2 | **82.2%** | 79.4% | 77.5% | 70.2% | +2.8% |
...
|---------|------------|--------------|-------------|-------------------|----------|
| Anneal | 1405 ms | 0 ms | 156588 | 183 | 99.9% |
| Australian | 123 ms | 0 ms | 18745 | 456 | 97.6% |
| Auto | 1464 ms | 0 ms | 209009 | 237 | 99.9% |
| Breast-Cancer | 12 ms | 0 ms | 2836 | 265 | 90.7% |
| Cleve | 46 ms | 0 ms | 16274 | 279 | 98.3% |
| Crx | 145 ms | 0 ms | 30762 | 559 | 98.2% |
| Diabetes | 5 ms | 0 ms | 1585 | 219 | 86.2% |
| German | 455 ms | 1 ms | 89483 | 951 | 98.9% |
| Glass | 7 ms | 0 ms | 2021 | 143 | 92.9% |
| Heart | 33 ms | 0 ms | 15134 | 253 | 98.3% |
| Hepatitis | 120 ms | 0 ms | 38172 | 131 | 99.7% |
| Horse | 489 ms | 0 ms | 129386 | 404 | 99.7% |
| Hypo | 301 ms | 1 ms | 86450 | 186 | 99.8% |
| Iono | 414 ms | 0 ms | 129736 | 201 | 99.8% |
| Iris | 0 ms | 0 ms | 90 | 38 | 57.8% |
| Labor | 21 ms | 0 ms | 24003 | 51 | 99.8% |
| Led7 | 5 ms | 0 ms | 243 | 100 | 58.8% |
| Lymphography | 90 ms | 0 ms | 65800 | 170 | 99.7% |
| Pima | 2 ms | 0 ms | 1585 | 219 | 86.2% |
| Sick | 262 ms | 1 ms | 85874 | 291 | 99.7% |
| Sonar | 1275 ms | 0 ms | 160000 | 178 | 99.9% |
| Tic-Tac-Toe | 11 ms | 0 ms | 7047 | 182 | 97.4% |
| Vehicle | 76 ms | 0 ms | 36922 | 492 | 98.7% |
| Waveform | 580 ms | 5 ms | 75473 | 2650 | 96.5% |
| Wine | 23 ms | 0 ms | 16933 | 62 | 99.6% |
| Zoo | 23 ms | 0 ms | 13758 | 76 | 99.4% |

## F1 / Precision / Recall (macro average over folds)

| Dataset | Accuracy | Precision (macro) | Recall (macro) | F1 (macro) | F1 (weighted) |
|---------|---------:|------------------:|---------------:|-----------:|--------------:|
| Anneal | 0.9821 | 0.8284 | 0.8161 | 0.8191 | 0.9773 |
| Australian | 0.8652 | 0.8648 | 0.8635 | 0.8633 | 0.8650 |
| Auto | 0.8185 | 0.8396 | 0.8121 | 0.8048 | 0.8153 |
| Breast-Cancer | 0.9721 | 0.9683 | 0.9707 | 0.9693 | 0.9721 |
| Cleve | 0.8159 | 0.8217 | 0.8125 | 0.8117 | 0.8137 |
...
| Wine | 0.9509 | 0.9613 | 0.9535 | 0.9520 | 0.9501 |
| Zoo | 0.9652 | 0.9081 | 0.9371 | 0.9181 | 0.9530 |
| **Average** | **0.8538** | **0.8315** | **0.8078** | **0.8078** | **0.8450** |
